...
description: "Build the Chief of Staff Agent, the required governance agent that coordinates, routes, prioritizes, and resolves conflicts across agents and jointly owns the AOS Workspace router. Use when standing up an AOS or later via 'Build the Chief of Staff Agent'."
---
