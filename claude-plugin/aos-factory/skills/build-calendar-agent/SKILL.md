...
description: "Build the Calendar Agent, an optional productive AOS agent that owns scheduling: reading availability, proposing times, and creating or changing calendar events under approval. Use when selected during AOS setup or later via 'Build the Calendar Agent'."
---
