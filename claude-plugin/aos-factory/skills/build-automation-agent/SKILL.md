...
description: "Build the Automation Agent, an optional productive AOS agent that owns automation and tool-use: scripting, integrations, and recurring automated actions on behalf of other agents. Use when selected during AOS setup or later via 'Build the Automation Agent'."
---
