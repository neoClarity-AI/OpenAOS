...
description: "Build the Writing Agent, an optional productive AOS agent that owns long-form content and drafting: documents, posts, and written deliverables distinct from message replies. Use when selected during AOS setup or later via 'Build the Writing Agent'."
---
