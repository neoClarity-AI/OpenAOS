...
description: "Build the Review Agent, the required governance agent that owns retrospectives, system improvement, the review cadence, decision audits, AOS refinement, the AOS User Guide, and aos_version reconciliation. Use when standing up an AOS or later via 'Build the Review Agent'."
---
