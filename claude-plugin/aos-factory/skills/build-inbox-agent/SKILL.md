...
description: "Build the Inbox Agent, an optional productive AOS agent that triages incoming communications and drafts responses, promoting items into other agents' domains. Use when selected during AOS setup or later via 'Build the Inbox Agent'."
---
